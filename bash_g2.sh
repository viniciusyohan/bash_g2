...
#Autor Vinicius Dreyer De Araujo
# Este script tem o objetivo de disponibilizar formas de efetuar um backup de arquivos em computadores, com os comandos Rsync ou Scp
...
principal() {           
 ...
 # seja igual a "4", então faça as instruções abaixo
            clear
            define_socket     
 # executa os comandos da função "define_socket"
            ;;          
 # os 2 ";;" (ponto e virgula)
 # significam que chegou ao final
 # esta opção do comando case
 ...
 # seja igual a "6", então faça as instruções abaixo
            clear
            efetua_backup     
 # executa os comandos da função "efetua_backup"
            ;;          
 # os 2 ";;" (ponto e virgula)
 # significam que chegou ao final
 # esta opção do comando case
